...
> **Note:** This fork was developed as part of my B.Sc. thesis *"Identifying Anonymized Speakers Through their Prosody"* at TU Berlin. It extends the original [SpAnE framework](https://github.com/carlosfranzreb/spane) with prosody-based speaker identification methods to evaluate how effectively anonymization systems conceal speaker identity.
